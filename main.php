    ...
    <header>
        <div class="header_left">
            <button class="homebut">
                <a href="./main.html" title="Home" class="qrsvg"><img class="logo" src="./img/QR.jpg"></a>
            </button>
            <div class="qazrep">
                <p>QAZAQ REPUBLIC</p>
            </div>
        ...
        <div class="header_right">
            <div class="signup">
                <a href="./forms/registration.php"><?php echo $_SESSION['user']['full_name']; ?></a>
            </div>
...
<!-- Content -->
    ...
    <video class="video" width=100% controls >
        <source src="https://drive.google.com/uc?export=preview&id=1qu1vZ01pUHCqvG98SWdBrZMuzj-po-i0" type="video/mp4">
...
<!-- Footer -->
    ...
    <footer>
        ...
        <div class = "copyright" style="background-color: #0045c0;">
          © 2017 Copyright:
          <a class="footer_a" href="main.html">Qazaq Republic - Design: Dollar Bills</a>
        </div>
        <!-- Copyright -->
      </footer>
