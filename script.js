...
function change(element){
    ...
    switch(a){
        case "-Almaty-":
            document.getElementById("map").src="./img/almaty.png";
            ...
            break;
        case "-Nur-Sultan-":
            document.getElementById("map").src="./img/astana.png";
            ...
            break;
        case "-Shymkent-":
            document.getElementById("map").src="./img/shym.png";
